...
public class AddProductController implements Initializable {
	...
	@FXML
	public Button deleteAssociatedPartBtn;
	@FXML
	...
	@FXML
	public TableColumn<Part, Integer> selectedPartsTableIDCol;
	@FXML
	public TableColumn<Part, String> selectedPartsTableNameCol;
	@FXML
	public TableColumn<Part, Double> selectedPartsTablePriceCol;
	@FXML
	public TableColumn<Part, Integer> selectedPartsTableInvCol;
	...
	@FXML
	public void addAssociatedPartBtnAction(ActionEvent event) {
	...
	@FXML
	public void deleteAssociatedPartBtnAction(ActionEvent event) {
		if (partsTable.getSelectionModel().getSelectedItem() != null) {
	...
	@FXML
	public void partSearchBtnAction(ActionEvent event) {
